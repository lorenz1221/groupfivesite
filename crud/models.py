...
class Users(models.Model):
    ...
    user_id = models.BigAutoField(primary_key=True, blank=False) # user_id BIGINT NOT NULL AUTO_INCRETEMENT PRIMARY KEY
    ...
    birth_date = models.DateField(blank=False) # birthdate DATE NOT NULL
    address = models.CharField(max_length=55, blank=False) # address VARCHAR(255) NOT NULL
